...
public class robot_hardware {
    static DcMotor lf_drive,lr_drive,rr_drive,rf_drive,arm,left_intake,right_intake;
    ...
    public robot_hardware(HardwareMap hw, Telemetry telemetry){
        try {
            ...
            left_intake = hw.get(DcMotor.class,"LeftIntake");
            right_intake = hw.get(DcMotor.class,"RightIntake");
