...
public class SkystoneNavigation extends Thread{
    ...
    public boolean getPosition = false;
    public boolean getOrientation = false;
    ...
    boolean startNavigaitonFlag = false;
    public VectorF translation = null;
    public Orientation rotation = null;

    public SkystoneNavigation(MecanumChassis robot, Telemetry telemetry){
        this.telemetry = telemetry;
        this.robot = robot;
        cameraMonitorViewId = robot.hwMap.appContext.getResources().getIdentifier("cameraMonitorViewId", "id", robot.hwMap.appContext.getPackageName());
        parameters = new VuforiaLocalizer.Parameters(cameraMonitorViewId);

        // OR...  Do Not Activate the Camera Monitor View, to save power
        // VuforiaLocalizer.Parameters parameters = new VuforiaLocalizer.Parameters();

        parameters.vuforiaLicenseKey = "";
    ...
    public void run(){
        ...
        startNavigaitonFlag = true;
        while(startNavigaitonFlag){
