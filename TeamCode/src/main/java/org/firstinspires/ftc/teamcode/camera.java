        ...
        while (!isStopRequested()) {
            ...
            if (targetVisible) {
                ...
                telemetry.addData("Rot (deg)", "{Roll, Pitch, Heading} = %.0f, %.0f, %.0f", rotation.firstAngle, rotation.secondAngle, rotation.thirdAngle);
                    ...
                    double turn_kp = 0.2;
                    float distance_x = translation.get(0) / mmPerInch;
                robot.lf_drive.setPower(+ Heading*turn_kp-distance_x);
                robot.rf_drive.setPower(- Heading*turn_kp-distance_x);
                robot.lr_drive.setPower(+ Heading*turn_kp-distance_x);
                robot.rr_drive.setPower(- Heading*turn_kp-distance_x);
