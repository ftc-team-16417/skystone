...
public class MecanumAutoRedV1 extends LinearOpMode {
...
*/
        ...
        */
        ...
        mecanumAutoDrive.straferTask(0.73,0,-0.2,0.05,5);
     ...
     //   robot.autoLeftClawL.setPosition(LEFT_CLAWL_INI - 0.2);
        ...
        mecanumAutoDrive.straferTask(OFFSET_Y + 0.04,0,0.2,0.05,5);
